package org.exframework.business.developer.message.entity;
...
public class MessageUnion implements Serializable {
	...
	public MessageUnion(String typeCode, String sourceData, @NotEmpty String subject, @NotEmpty String content,
		...
		this(typeCode, sourceData, subject, content, target, messageType, ip, null, null, null, null, null);
	}
