...
public class WechatComAppUpdateEvent extends RemoteApplicationEvent {

	private static final long serialVersionUID = -968292605391739532L;

	public WechatComAppUpdateEvent() {
		super();
	}

	public WechatComAppUpdateEvent(String source, String originService, String destinationService) {
		super(source, originService, destinationService);
	}

	public WechatComAppUpdateEvent(String source, String originService) {
