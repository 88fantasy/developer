package org.exframework.business.developer.wechat.service.com;
...
import org.exframework.business.developer.core.enums.WeChatSendMessageEnum;
import org.exframework.business.developer.wechat.constant.WeChatComConstants;
...
import org.exframework.business.developer.wechat.http.client.com.WeChatComClient;
import org.exframework.business.developer.wechat.http.client.com.entity.GetSessionResponse;
	...
	public String getComToken(int agentId) {
		...
		if (token == null || "".equals(token)) {
			...
			if (coms != null && coms.containsKey(agentIdString)) {
				...
				org.exframework.business.developer.wechat.entity.GetTokenResponse response = weChatComClient
